...
parser.add_argument('--exp', type=str,  default='MCNet_sdf', help='exp_name') 
parser.add_argument('--model', type=str,  default='mcnet3d_v2', help='model_name') # v1 , v2
parser.add_argument('--gpu', type=str,  default='0', help='GPU to use')
parser.add_argument('--detail', type=int,  default=1, help='print metrics for every samples?')
parser.add_argument('--labelnum', type=int, default=8, help='labeled data')   # 8 , 16
parser.add_argument('--nms', type=int, default=0, help='apply NMS post-procssing?')

FLAGS = parser.parse_args()
os.environ['CUDA_VISIBLE_DEVICES'] = FLAGS.gpu
version = FLAGS.model.split('_')[-1]

snapshot_path = FLAGS.root_path + "model/{}_{}_{}_labeled_{}/{}".format(FLAGS.dataset_name, FLAGS.exp, FLAGS.labelnum,version, FLAGS.model) # v1 , v2
test_save_path = FLAGS.root_path + "model/{}_{}_{}_labeled_{}/{}_predictions/".format(FLAGS.dataset_name, FLAGS.exp, FLAGS.labelnum, version, FLAGS.model) # v1 , v2
