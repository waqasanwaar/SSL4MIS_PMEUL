...
def Inference(FLAGS):
    ...
    result_test_save_path = "./model/ACDC_{}_{}_labeled/performance.txt".format(FLAGS.exp, FLAGS.labelnum)
    with open(result_test_save_path, 'w') as f:
        ...
        for case in tqdm(image_list):
            ...
            f.writelines("Dice for cl1 : cl2 : cl3 {},{},{},{}\n".format(case,
                        round(  first_metric[0] ,4),#first_metric[1],first_metric[2],first_metric[3],
                        round(  second_metric[0],4),#second_metric[1],second_metric[2],second_metric[3], 
                        round(  third_metric[0],4),#third_metric[1],third_metric[2],third_metric[3] 
                          ))
